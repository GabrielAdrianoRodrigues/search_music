...
import br.com.models.dtos.AlbumDTO;
...
public class AlbumService {
    ...
    public List<AlbumDTO> buscarAlbunsByNome(String nome) {
        return albumDAO.buscarAlbunsByNome(nome).stream().map(AlbumDTO::new).collect(Collectors.toList());
    }
